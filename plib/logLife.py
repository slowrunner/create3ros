...
#              to /home/pi/rosbot-on-gopigo3/life.log
#
# with sudo crontab -e
#      @reboot /home/pi/rosbot-on-gopigo3/nohup_loglife.py
# touch /home/pi/rosbot-on-gopigo3/life.log
# chmod 777 /home/pi/rosbot-on-gopigo3/life.log
#

import time
import sys
sys.path.insert(1,"/home/ubuntu/create3ros/plib/")
...
loghandler = logging.FileHandler('/home/ubuntu/create3ros/life.log')
